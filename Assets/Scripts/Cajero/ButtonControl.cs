...
public class ButtonControl : MonoBehaviour
{
    ...
    public void MovePromos()
    {
        ...
        StartCoroutine(MoveToPosition(Afirmar, new Vector3(afirmarOriginalPos.x, -554f, promosOriginalPos.z),1000f));
        StartCoroutine(MoveToPosition(Promos, new Vector3(-565f, promosOriginalPos.y, promosOriginalPos.z),2000f));
    }
